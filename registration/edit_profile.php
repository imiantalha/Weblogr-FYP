...
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Edit Profile | Weblogr</title><script src="../assets/form-validation.js" defer></script><link rel="stylesheet" href="style.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"/></head><body><?php include '../posts/sidebar.php'; ?><main class="container"><h1>Edit Profile</h1><div class="profile-container"><form action="" method="post" enctype="multipart/form-data" novalidate><input type="hidden" name="csrf_token" value="<?php echo $csrf; ?>"><?php if($error): ?><p class="form-alert" role="alert"><?php echo htmlspecialchars($error,ENT_QUOTES,'UTF-8'); ?></p><?php endif; ?><label for="first_name">First Name</label><input type="text" id="first_name" name="first_name" maxlength="50" value="<?php echo htmlspecialchars((string)$profile['first_name'],ENT_QUOTES,'UTF-8'); ?>" required data-label="First name"><br><label for="last_name">Last Name</label><input type="text" id="last_name" name="last_name" maxlength="50" value="<?php echo htmlspecialchars((string)$profile['last_name'],ENT_QUOTES,'UTF-8'); ?>" required data-label="Last name"><br><label for="bio">Bio</label><textarea id="bio" name="bio" rows="5" maxlength="1000"><?php echo htmlspecialchars((string)$profile['bio'],ENT_QUOTES,'UTF-8'); ?></textarea><br><label for="profile_picture">Profile Picture</label><input type="file" id="profile_picture" name="profile_picture" accept="image/jpeg,image/png,image/gif,image/webp"><br><button class="profile-btn" type="submit">Save Changes</button></form></div></main></body></html>
