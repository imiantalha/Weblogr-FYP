...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 elseif(mb_strlen($bio)>1000)$error='Bio must be 1000 characters or fewer.';
  ...
  $profile_picture=$profile['profile_picture'];$new_file=null;$destination=null;
...
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Edit Profile | Weblogr</title><script src="../assets/form-validation.js" defer></script><link rel="stylesheet" href="style.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"></head><body>
<?php include '../posts/sidebar.php'; ?>
<main class="content"><div class="account-shell"><div class="profile-form-card"><section class="account-card">
...
<div class="profile-form-grid"><label>First name<input type="text" name="first_name" maxlength="50" value="<?php echo e((string)$profile['first_name']); ?>" required data-label="First name"></label><label>Last name<input type="text" name="last_name" maxlength="50" value="<?php echo e((string)$profile['last_name']); ?>" required data-label="Last name"></label>
