...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user !== null && (int) $user['is_verified'] === 1) {
            ...
            $_SESSION['otp_purpose'] = 'password_reset'; $_SESSION['otp_email'] = $email; $_SESSION['otp_expires_at'] = time() + 600; $_SESSION['otp_resend_available_at'] = time() + 30;
