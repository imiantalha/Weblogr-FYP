...
if ($next === '' || !str_starts_with($next, '../') || str_contains($next, '://') || str_contains($next, "\0")) {
...
$url = google_oauth_authorization_url($config, $state, google_oauth_code_challenge($verifier));
