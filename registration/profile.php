...
$s = $con->prepare('SELECT first_name,last_name,username,bio,profile_picture FROM users WHERE user_id=? LIMIT 1');
...
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#2563eb"><title>My Profile | Weblogr</title><link rel="icon" href="../assets/weblogr-mark.svg" type="image/svg+xml"><link rel="apple-touch-icon" href="../assets/weblogr-mark.svg" type="image/svg+xml"><link rel="stylesheet" href="style.css"><link rel="stylesheet" href="../assets/weblogr-product.css"><link rel="stylesheet" href="../assets/responsive.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css"></head><body>
...
<div class="profile-main"><p class="eyebrow">YOUR PROFILE</p><h1><?php echo e($full_name); ?></h1><?php if($username!==''): ?><p class="profile-username"><i class="fas fa-at"></i><?php echo e($username); ?></p><?php endif; ?><p><?php echo e($bio!==''?$bio:'Tell readers a little about yourself.'); ?></p><div class="profile-stats"><div><strong><?php echo $post_count; ?></strong><span>Posts</span></div><div><strong><?php echo $follower_count; ?></strong><span>Followers</span></div><div><strong><?php echo $following_count; ?></strong><span>Following</span></div></div></div>
...
<a href="edit_profile.php"><i class="fas fa-user-edit"></i><span><strong>Profile details</strong><small>Update your username, name, bio, and profile picture.</small></span><i class="fas fa-chevron-right"></i></a>
...
<style>.profile-username{display:inline-flex!important;align-items:center;gap:6px;margin:0 0 12px!important;color:#64748b!important;font-size:14px!important;font-weight:600}.profile-username i{color:#2563eb;font-size:12px}</style>
